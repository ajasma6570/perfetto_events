export const title = "Event Management Dubai"
const siteName = process.env.SITE_NAME || "Perfetto Events";
const siteUrl = process.env.SITE_URL || "https://perfettoevents.ae";
